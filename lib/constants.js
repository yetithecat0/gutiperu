...
export const PROYECTOS = [
  ...
  {
    id: 'latelier',
    nombre: 'L´atelier Peruano',
    categoria: 'Empresa en Suiza',
    descripcion:
      "L'Atelier Peruano es un referente de joyería artesanal en Suiza. Creaciones Únicas en Plata 925.",
    href: '/latelierperuano',
    accentColor: 'linear-gradient(90deg, #A0AEC0, #E2E8F0)',
    wide: false,
  },
]
...
export const INVERSION_DATA = {
  ...
  parrafos: [
    ...
    'Tengo un ecosistema de seis marcas en distintas etapas: desde startups con tracción hasta SaaS en desarrollo activo. Si eres inversor ángel, fondo seed o simplemente alguien que quiere co-construir algo relevante en Perú y Latinoamérica — hablemos.',
  ],
...
export const FOOTER_DATA = {
  ...
  proyectos: [
    ...
    { label: 'ATI',                 href: '/ati' },
    { label: 'L´atelier Peruano',   href: '/latelierperuano' },
  ],
  redes: [
